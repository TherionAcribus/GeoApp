...
Write-Host "  2. Frontend: cd frontend ; yarn ; yarn build:dev"
Write-Host "  3. Mettre à jour config.py (PLUGINS_DIR, ALPHABETS_DIR)"
Write-Host "  4. Initialiser le nouveau repo: git init && git add -A && git commit -m 'Initial monorepo commit'"
Write-Host ""
