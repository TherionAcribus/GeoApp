"""Official plugin: coordinate_grid_converter."""
...
class CoordinateGridConverterPlugin:
    def __init__(self):
        self.name = "coordinate_grid_converter"
        self.version = "1.0.0"

    def execute(self, inputs: Dict[str, Any]) -> Dict[str, Any]:
        start = time.time()
        try:
            payload = convert_to_grid(
            ...
            return self._ok(start, "Conversion de grille terminée", [item])
...
plugin = CoordinateGridConverterPlugin()
