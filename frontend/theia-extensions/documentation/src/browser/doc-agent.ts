...
export class GeoAppDocAgent extends AbstractStreamParsingChatAgent {
    ...
    protected override async getSystemMessageDescription(
        ...
        const systemPrompt = [
            ...
            '- aide_list_preferences(category?) — Liste les préférences avec valeurs courantes. Catégories : ai, earthcoach, chat, ui, map, plugins, ocr, images, updates, backend, logs, search.',
