...
export class GeoAppDocAgent extends AbstractStreamParsingChatAgent {
    ...
    protected override async getSystemMessageDescription(
        ...
        const systemPrompt = [
            ...
            '- Si les identifiants nécessaires (zone_id, geocache_id, plugin_name, alphabet_id...) sont inconnus, utilise d\'abord le tool de liste approprié (aide_list_zones, aide_list_geocaches_in_zone, aide_list_plugins, aide_list_alphabets) pour les obtenir, puis enchaîne immédiatement avec l\'action.',
