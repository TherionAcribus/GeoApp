...
import { GeocacheLogImagesService } from './geocache-log-images-service';
...
import { GeoAppAiScorerAgentContribution } from './geoapp-ai-scorer-agent';
...
import { GeoAppLogImproverAgentContribution } from './geoapp-log-improver-agent';
...
export default new ContainerModule(bind => {
    ...
    bind(GeoAppAiScorerAgentContribution).toSelf().inSingletonScope();
    bind(FrontendApplicationContribution).toService(GeoAppAiScorerAgentContribution);
    ...
    bind(GeoAppLogImproverAgentContribution).toSelf().inSingletonScope();
    bind(FrontendApplicationContribution).toService(GeoAppLogImproverAgentContribution);
