...
À ce jour le dépôt contient **85 plugins officiels** (`plugins/official/`) et un répertoire `plugins/custom/` pour les plugins utilisateur.
...
│   ├── official/                       # 85 plugins fournis (lecture seule)
│   │   └── affine_code/
