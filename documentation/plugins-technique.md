...
À ce jour le dépôt contient **105 plugins officiels** (`plugins/official/`) et un répertoire `plugins/custom/` pour les plugins utilisateur.
...
│   ├── official/                       # 105 plugins fournis (lecture seule)
│   │   └── affine_code/
