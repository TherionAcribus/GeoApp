...
À ce jour le dépôt contient **106 plugins officiels** (`plugins/official/`) et un répertoire `plugins/custom/` pour les plugins utilisateur.
...
│   ├── official/                       # 106 plugins fournis (lecture seule)
│   │   └── affine_code/
