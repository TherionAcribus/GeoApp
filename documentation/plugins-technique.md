...
À ce jour le dépôt contient **104 plugins officiels** (`plugins/official/`) et un répertoire `plugins/custom/` pour les plugins utilisateur.
...
│   ├── official/                       # 104 plugins fournis (lecture seule)
│   │   └── affine_code/
